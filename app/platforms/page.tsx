      ...
      <main id="main-content" tabIndex={-1} className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-3 [content-visibility:auto] [contain-intrinsic-size:820px]">
          {platforms.map((platform) => (
            <article id={platform.id} key={platform.id} className="scroll-mt-[calc(var(--site-header-height,4rem)+1rem)] rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6">
